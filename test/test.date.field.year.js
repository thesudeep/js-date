...
DateTime.Field.Year.Test.testGetMills_Mills_946684800000 = function() {
    var year = new DateTime.Field.Year().millis(946684800001);

    assertEquals(946684800000, year.millis());
};
